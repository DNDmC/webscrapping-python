...
# Definindo o caminho para o arquivo JSONL
df = pd.read_json('data/data.jsonl', lines = True)

# Configurar o pandas para mostrar todas aas colunas
pd.options.display.max_columns = None

# Adicionar coluna _source com um valor fixo
df['_source'] = "https://lista.mercadolivre.com.br/notebook"

# Adicionar a _data_coleta com a data e horas atuais
...
# Tratar preços como floats e calcular os valores totais 
